...
void main() async {
  ...
  runApp(const LocalPulseDemoApp());
}

class LocalPulseDemoApp extends StatelessWidget {
  const LocalPulseDemoApp({super.key});
      ...
      body: const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text('Report Issue Form', style: TextStyle(fontSize: 18)),
